...
title: "How to Calculate Peptide Price Per Mg | Peptide Price Lab"
h1: "How to Calculate Peptide Price Per Mg (And Why Vial Price Misleads)"
lede: "Two vendors. Two prices. Same peptide. Without knowing what you're paying per milligram, there's no way to know which is actually cheaper. Here's the formula, and where the comparison gets more complicated."
date: "2026-05-23"
readingTime: "5 min read"
description: "Vial price is meaningless without knowing the mg count. Here's how to calculate real peptide cost per mg, account for purity, and compare vendors fairly."
ogDescription: "Vial price is meaningless without knowing the mg count. Here's the formula, a worked example, and a free calculator tool."
schema:
  "@context": "https://schema.org"
  "@type": "Article"
  headline: "How to Calculate Peptide Price Per Mg"
  description: "A practical guide to calculating real peptide cost per mg, accounting for purity, and comparing vendors accurately."
  url: "https://peptidepricelab.com/start-here/how-to-calculate-peptide-price-per-mg/"
  publisher:
    "@type": "Organization"
...
<h2>The problem with listing price</h2>
...
<div class="formula-box">
  ...
  <div class="formula-text">Price per mg = Total vial cost ÷ Milligrams in vial</div>
</div>
...
<div class="example-card">
  <div class="example-label">Worked Example: BPC-157</div>
  <table>
    <tr><td>Vendor A vial price</td><td>$42</td></tr>
    <tr><td>Vial size</td><td>5 mg</td></tr>
    <tr><td>Shipping</td><td>$0 (free)</td></tr>
    <tr class="result-row"><td>Cost per mg</td><td>$8.40 / mg</td></tr>
  </table>
  <br>
  <table>
    <tr><td>Vendor B vial price</td><td>$68</td></tr>
    <tr><td>Vial size</td><td>10 mg</td></tr>
    <tr><td>Shipping</td><td>$0 (free)</td></tr>
    <tr class="result-row"><td>Cost per mg</td><td>$6.80 / mg</td></tr>
  </table>
</div>

<h2>Adjusting for purity claims</h2>
...
<p>To account for purity, you can calculate an adjusted cost per mg of pure peptide:</p>

<div class="formula-box">
  <div class="formula-label">Purity-Adjusted Formula</div>
  <div class="formula-text">Adjusted cost = Total cost ÷ (mg × purity%)</div>
</div>
...
<h2>Comparing across vial sizes and multi-vial orders</h2>
...
<div class="example-card">
  <div class="example-label">Multi-Vial Comparison</div>
  <table>
    <tr><td>1 × 5 mg vial at $42</td><td>$8.40 / mg</td></tr>
    <tr><td>3 × 5 mg vials at $110</td><td>$7.33 / mg</td></tr>
    <tr><td>1 × 10 mg vial at $68</td><td>$6.80 / mg</td></tr>
    <tr class="result-row"><td>Cheapest per mg</td><td>Single 10 mg vial</td></tr>
  </table>
</div>

<h2>What "mg" actually means on the label</h2>
...
<h2>Why this matters more for some peptides</h2>
...
<div class="article-cta">
  <div class="cta-text">
    <div class="cta-title">Skip the spreadsheet</div>
    <div class="cta-sub">Enter your vendors and vials in the free PPL tool. It calculates per-mg cost, handles purity adjustments, and lets you compare side by side.</div>
  </div>
  <a href="https://app.peptidepricelab.com" class="btn-white">Open the Calculator →</a>
</div>

<h2>A note on using price as a quality signal</h2>
...
<div class="related-section">
  ...
  <div class="related-links">
    <a href="/peptides/bpc-157/" class="related-link">
      BPC-157 — Research Notes &amp; Price Per Mg
      <span class="arrow">›</span>
    </a>
    <a href="/peptides/semaglutide/" class="related-link">
      Semaglutide — Research Notes &amp; Price Per Mg
      <span class="arrow">›</span>
    </a>
    <a href="/peptides/tb-500/" class="related-link">
      TB-500 — Research Notes &amp; Price Per Mg
      <span class="arrow">›</span>
    </a>
    <a href="/sources/" class="related-link">
      Sources Directory — Research Peptide Vendors
      <span class="arrow">›</span>
    </a>
  </div>
</div>
